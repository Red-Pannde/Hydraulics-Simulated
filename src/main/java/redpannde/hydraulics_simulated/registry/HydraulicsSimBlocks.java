...
public class HydraulicsSimBlocks {
    ...
    public static final BlockEntry<PneumaticPistonBlock> PNEUMATIC_PISTON_BLOCK = REGISTRATE
            .block("pneumatic_piston", PneumaticPistonBlock::new)
            .item()
            .transform(customItemModel())
            .register();

    public static final BlockEntry<AbstractPistonPlateBlock> PISTON_LINK_BLOCK = REGISTRATE
            .block("swivel_bearing_link_block", AbstractPistonPlateBlock::new)
            .blockstate((ctx, prov) -> prov.directionalBlock(
                    ctx.getEntry(), blockState -> prov.models().getExistingFile(
